...
public class BasePage {
  ...
  private void logStep(String description,By locator) {
    ExtentReportManager.getTest()
        .log(Status.INFO,description + "<details><summary>Locator Details</summary><pre>" + formatLocator(locator)
            + "</pre></details>");
  }
  ...
  protected void retryClick(WebElement element,int maxRetries,String stepDesc) {
    ...
    ExtentReportManager.getTest()
        .log(Status.FAIL,"Unable to click element after " + maxRetries + " retries: " + describeElement(element));
  ...
  protected void waitUntilElementIsVisible(WebElement element,int waitTimeInSeconds) {
    try {
      ...
      ExtentReportManager.getTest()
          .log(Status.FAIL,"Element was not visible within " + waitTimeInSeconds + "s: " + describeElement(element));
  ...
  protected List<WebElement> waitForAllInputs(By locator,int expectedSize) {
    ...
    ExtentReportManager.getTest()
        .log(Status.INFO,"Located at least " + expectedSize + " elements for: " + locator.toString());
  ...
  public void scrollAndClickByAccessibilityId(String accessibilityId,WebElement scrollableContainer,int maxScrolls,
    ...
    throw new AssertionError(
        "Element with accessibilityId '" + accessibilityId + "' not found after " + maxScrolls + " scroll attempts.");
  }
  ...
  public boolean scrollAndCheckVisibilityByAccessibilityId(String accessibilityId,String stepDesc) {
    ...
    ExtentReportManager.getTest()
        .log(Status.INFO,"Element with accessibilityId '" + accessibilityId + "' was NOT visible after "
            + maxPageScrolls + " scroll attempts.");
