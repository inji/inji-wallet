...
public class FarmerFlowSanityTest extends AndroidBaseTest {
  ...
  public void downloadFarmerVCAndDeleteSmoke() throws InterruptedException {
    ...
    assertTrue(historyPage.verifyHistoryForFarmerCredential("is downloaded", PlatformType.ANDROID));
    assertTrue(historyPage.verifyDeleteHistoryFarmerCredential("is removed from the wallet",PlatformType.ANDROID));
  }
}
