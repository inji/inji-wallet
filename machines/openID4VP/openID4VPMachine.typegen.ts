...
export interface Typegen0 {
  ...
  internalEvents: {
    ...
    'done.invoke.OpenID4VP.checkVerifierTrust:invocation[0]': {
      type: 'done.invoke.OpenID4VP.checkVerifierTrust:invocation[0]';
      data: unknown;
      __tip: 'See the XState TS docs to learn how to strongly type this.';
    };
    ...
    'done.invoke.OpenID4VP.sendingVP.sendVP:invocation[0]': {
      type: 'done.invoke.OpenID4VP.sendingVP.sendVP:invocation[0]';
      data: unknown;
      __tip: 'See the XState TS docs to learn how to strongly type this.';
    };
    'done.invoke.OpenID4VP.storeTrustedVerifier:invocation[0]': {
      type: 'done.invoke.OpenID4VP.storeTrustedVerifier:invocation[0]';
      data: unknown;
      __tip: 'See the XState TS docs to learn how to strongly type this.';
    };
    ...
    'error.platform.OpenID4VP.checkVerifierTrust:invocation[0]': {
      type: 'error.platform.OpenID4VP.checkVerifierTrust:invocation[0]';
      data: unknown;
    };
    ...
    'error.platform.OpenID4VP.sendingVP.constructVP.constructing:invocation[0]': {
      type: 'error.platform.OpenID4VP.sendingVP.constructVP.constructing:invocation[0]';
      data: unknown;
    };
    'error.platform.OpenID4VP.sendingVP.sendVP:invocation[0]': {
      type: 'error.platform.OpenID4VP.sendingVP.sendVP:invocation[0]';
      data: unknown;
    };
    'error.platform.OpenID4VP.storeTrustedVerifier:invocation[0]': {
      type: 'error.platform.OpenID4VP.storeTrustedVerifier:invocation[0]';
      data: unknown;
    };
    'error.platform.signVP:invocation[0]': {
      type: 'error.platform.signVP:invocation[0]';
      data: unknown;
    };
    'xstate.after(200)#OpenID4VP.consentRejected': {
      type: 'xstate.after(200)#OpenID4VP.consentRejected';
    };
  ...
  eventsCausingActions: {
    ...
    resetIsShowLoadingScreen:
      ...
      | 'done.invoke.OpenID4VP.authenticateVerifier:invocation[0]'
      | 'done.invoke.OpenID4VP.checkKeyPair:invocation[0]'
      | 'done.invoke.OpenID4VP.matchVPRequestWithVCs:invocation[0]'
      | 'error.platform.OpenID4VP.authenticateVerifier:invocation[0]'
      | 'error.platform.OpenID4VP.getTrustedVerifiersList:invocation[0]'
      | 'xstate.stop';
  ...
  matchesStates:
    ...
    | 'sendingVP'
    | 'sendingVP.constructVP'
    | 'sendingVP.constructVP.constructing'
    | 'sendingVP.constructVP.signVP'
    | 'sendingVP.prepare'
    | 'sendingVP.sendVP'
    | 'setSelectedVC'
    ...
    | {
        sendingVP?:
          ...
          | 'prepare'
          | 'sendVP'
          | {constructVP?: 'constructing' | 'signVP'};
      };
  tags: never;
}
